...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "es.jorgesanz.grpcservice.prototype.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<es.jorgesanz.grpcservice.prototype.Person,
      es.jorgesanz.grpcservice.prototype.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = es.jorgesanz.grpcservice.prototype.Person.class,
      responseType = es.jorgesanz.grpcservice.prototype.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<es.jorgesanz.grpcservice.prototype.Person,
      es.jorgesanz.grpcservice.prototype.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<es.jorgesanz.grpcservice.prototype.Person, es.jorgesanz.grpcservice.prototype.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<es.jorgesanz.grpcservice.prototype.Person, es.jorgesanz.grpcservice.prototype.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "es.jorgesanz.grpcservice.prototype.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  es.jorgesanz.grpcservice.prototype.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  es.jorgesanz.grpcservice.prototype.Greeting.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(es.jorgesanz.grpcservice.prototype.Person request,
        io.grpc.stub.StreamObserver<es.jorgesanz.grpcservice.prototype.Greeting> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                es.jorgesanz.grpcservice.prototype.Person,
                es.jorgesanz.grpcservice.prototype.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public es.jorgesanz.grpcservice.prototype.Greeting sayHello(es.jorgesanz.grpcservice.prototype.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<es.jorgesanz.grpcservice.prototype.Greeting> sayHello(
        es.jorgesanz.grpcservice.prototype.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((es.jorgesanz.grpcservice.prototype.Person) request,
              (io.grpc.stub.StreamObserver<es.jorgesanz.grpcservice.prototype.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return es.jorgesanz.grpcservice.prototype.HelloWorld.getDescriptor();
    }
